...
import styles from "@/styles/components/ui/sheet.module.scss"
...
const sheetVariants = cva(styles["sheet-variant"], {
  variants: {
    side: {
      top: styles["sheet-variant-top"],
      bottom: styles["sheet-variant-bottom"],
      left: styles["sheet-variant-left"],
      right: styles["sheet-variant-right"],
    },
  },
  defaultVariants: {
    side: "right",
